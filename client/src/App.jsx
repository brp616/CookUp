...
function App() {
  ...
  const [myCookbooks, setMyCookbooks] = useState([
    { _id: 'default-1', title: "Cooked It", subtitle: "Tried & True", color: "#f3d2a2", icon: "✅", category: "cooked" },
    { _id: 'default-2', title: "To Cook", subtitle: "Future Feasts", color: "#a2d2f3", icon: "⏳", category: "to-cook" }
  ]);
  ...
  return (
    <div className="app-container">
      ...
      <BrowserRouter>
        ...
        <Routes>
          <Route path="/" element={<Feed posts={posts} myCookbooks={myCookbooks} user={user} />} />
          ...
          <Route path="/profile" element={<Profile currentUser={user} setUser={setUser} />} />
          <Route path="/profile/:userId" element={<Profile currentUser={user} setUser={setUser} />} />
          <Route path="/contact" element={<h1>Contact Us</h1>} />
          <Route path="/login" element={<Login setUser={setUser} />} />
          <Route path="/register" element={<Register setUser={setUser} />} />
          <Route path="/post/:id" element={<PostDetail user={user} myCookbooks={myCookbooks} />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
